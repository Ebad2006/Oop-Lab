...
int main()
{
    Hospital hosp1("Ahga Khan University Hospital");
    Doctor doc1("Khizar", "Neurosurgeon", 10);
    Doctor doc2("Hassan", "Cardio Surgeon", 15);
    hosp1.addDoctor(&doc1);
    hosp1.addDoctor(&doc2);
    hosp1.display();

    Hospital hosp2("Jinnah Hospital");
    Doctor doc3("Faris", "Physiotherapist", 18);
